...
function encuentraDatosCajaChicaDetalle($codigo){
     ...
     $stmt->execute();
     $numero=0;$personal=0;$proveedor=0;$monto=0;$observaciones="";$cod_uo=0;$cod_area=0;$codigo=0;$fecha="";$tipo_pago=0;$cod_cuenta=0;
     while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        $codigo=$row['codigo'];
     ...
     return array("codigo"=>$codigo,"nro_recibo"=>$numero,"cod_personal"=>$personal,"cod_proveedores"=>$proveedor,"monto"=>$monto,"observaciones"=>$observaciones,"cod_uo"=>$cod_uo,"cod_area"=>$cod_area,"fecha"=>$fecha,"cod_tipopago"=>$tipo_pago,"cod_cuenta"=>$cod_cuenta);
}
