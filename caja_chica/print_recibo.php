...
try{
  ...
  $tituloComprobante="   (".nameCuenta($cod_cuenta).")";
...
$html.='<body>'.
        ...
        '</script>';
$html.=  '';
       $html.='<div style="padding:15px !important;border:2px solid #000000;border-radius:20px;" ><img class="imagen-logo-izq2" style="position: absolute;padding-top: -2px;left: 30px;top: 20px;width:130px;height:130px;" src="../assets/img/tigo_icono.png">'.

             '<div><br>
              <center><h1>RECIBO DE CAJA</h1></center><center><h2>Of/Area: '.$oficina.'/'.$area.'</h2></center>
              <table style="padding-top:-45px;" width="100%"><tr><td align="center"><label></label></td><td align="right"><label style="color:#F31111; font-weight:bold; font-size:22px;">Nº &nbsp;&nbsp;&nbsp;&nbsp;'.$datos['nro_recibo'].'</label></td></tr>
        ...
        $html.='<table class="" width="100%" style="font-size:12px;">'.
           '<tbody>';
            $html.='<tr>'.
                '<td class="text-left" width="20%"><b>Beneficiario</b> </td>'.
            ...
            $html.='<tr>'.
                ...
                '<td class="text-left small" width="75%" valign="bottom"><label style="position:absolute;top:5px;">:</label><small><p style="padding-left:20px;">'.$datos['observaciones'].' '.$tituloComprobante.'</p></small></td>'.
            '</tr>';
            $html.='</tbody>';
            $html.='</table>';
...
$html.='</div></body>'.
      '</html>';           
descargarPDFCajaChicaHorizontal("VENCEDORES - Recibo Caja Chica ".$datos['nro_recibo']." (".$oficina.", ".$area.")",$html);
