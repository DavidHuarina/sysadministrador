...
<!--CONTENIDO-->
     <table class="table">
         <tr>
            <td class="s1 text-center" colspan="4">TIGO VENCEDORES</td>
            <td rowspan="3" class="text-center imagen-td"><img class="imagen-logo-izq_2" src="../assets/img/tigo_icono.png" width="90" height="90"></td>
        </tr>
        <tr>
