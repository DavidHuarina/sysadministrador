...
<div class="sidebar" data-color="purple" data-background-color="<?=$estiloMenu?>" data-image="assets/img/scz.jpg">
      <div class="logo">
        <a href="http://www.creative-tim.com" class="simple-text logo-mini">
          <img src="assets/img/tigo_icono.png" width="30" />
        </a>
          ...
          <li class="nav-item ">
            ...
            <div class="collapse" id="transaccConta">
              <ul class="nav">
                ...
                <!-- <li class="nav-item ">
                  <a class="nav-link" href="?opcion=listComprobantesSis">
                    <span class="sidebar-mini"> CS </span>
                    <span class="sidebar-normal"> Comprobantes SIS </span>
                  </a>
                </li> -->
                <li class="nav-item ">
              ...
              <ul class="nav">
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="reportes_ventas/index.php" target="_blank">
                    ...
                    <span class="sidebar-normal"> Reportes Generales</span>
                  </a>
                </li>
                <!-- <li class="nav-item ">
              ...
              <ul class="nav">
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="?opcion=listSolicitudRecursos">
                    ...
                    <span class="sidebar-normal"> Solicitudes de Recursos (SR)</span>
                  </a>
                </li>
                <li class="nav-item">
